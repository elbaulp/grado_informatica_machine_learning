...
lda.fit <- MASS::lda(OutcomeType ~ ., data = fit)

lda.predict <- predict(lda.fit, fit %>% dplyr::select(-OutcomeType))
mean(lda.predict$class != fit$OutcomeType)
lda.predict <- predict(lda.fit, test %>% dplyr::select(-OutcomeType))
mean(lda.predict$class != fit.test$OutcomeType)
```
...
mean(pred != fit.test$OutcomeType)
...
# 
# fit$OutcomeType <- as.factor(fit$OutcomeType)
# fit$AnimalType <- as.factor(fit$AnimalType)
# fit$neutered <- as.factor(fit$neutered)
# fit$sex <- as.factor(fit$sex)
# fit$OutcomeSubtype <- as.factor(fit$OutcomeSubtype)
# fit$SimpleColor <- as.factor(fit$SimpleColor)
# fit$SimpleBreed <- as.factor(fit$SimpleBreed)
# 
# fit.test <- test %>% dplyr::select(OutcomeType,
#                                AnimalType,
#                                neutered,
...
mean(svm.predicted.test != fit.test$OutcomeType)
```

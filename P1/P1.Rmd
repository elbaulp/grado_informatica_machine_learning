...
plot(symmetry.intensity$int, symmetry.intensity$sym,
     pch  = 20, 
     col  = symmetry.intensity$class,
     xlab = "Mean Intensity",
     ylab = "Vertical Symmetry",
     main = "Intensidad media y simetría vertical de los 1 y 5")
...
digits <- read.table("./DigitosZip/zip.train",
                     ...
                     comment.char = "",
                     stringsAsFactors = F)
digits.test <- read.table("./DigitosZip/zip.test",
                     quote = "",
                     comment.char = "",
                     stringsAsFactors = F)

ones.fives.train <- digits[digits$V1 == 1 | digits$V1 == 5,]
ones.fives.test <- digits.test[digits.test$V1 == 1 | digits.test$V1 == 5,]

...
knitr::opts_chunk$set(echo = TRUE, eval = T, cache = T)
...
y $1000$ para $E_{out}$, tenemos unos valores para $E_{out}$ entorno al $2.5\%$, y para
...
función objetivo $f (x1 , x2 ) = sign(x1^2 + x2^2 − 25,0)$ Generar una muestra
...
MyPlot(data[,-1], labels = y, xlim = c(-100, 100), ylim = c(-100, 100))
```

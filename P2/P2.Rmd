...
X.10.degree <- GenerateLegendreDataset(10, 1000, 1)
# X.2.degree <- GenerateLegendreDataset(2, 1000, 1)
...
*Veamos el resultado de estas hipótesis:*

```{r echo=F}
p <- (ggplot(X.10.degree, aes(x = x, y = y)) 
    + ggtitle("Data from a 10 Degree Legendre Polynomial")      
    + geom_point()
    + theme_bw())

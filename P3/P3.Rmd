...
glm.mpg.fit <- glm(mpg ~ ., data = data.auto.training)
glm.mpg.predict <- predict(glm.mpg.fit, data.auto.test)
glm.training.error <- mean((glm.mpg.fit$fitted.values - data.auto.training$mpg) ^ 2)
...
En principio se ha ajustado con un núcleo lineal, pero no se han obtenido buenos 

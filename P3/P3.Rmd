...
Tras ajustar este modelo de árbol, se puede deducir que las variables más predictoras
son `LoyalCH, SalePriceMM, PriceDiff` y `ListPriceDiff`. A continuación se muestra
el árbol generado:
